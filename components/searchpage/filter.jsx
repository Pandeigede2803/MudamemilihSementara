...
function Filter({ onFilterChange }) {
  ...
  const handleFilterChange = () => {
    // Call the callback function with the selected filter values
    onFilterChange({ name, partai, date, status });
  };

  return (
    <div className="m-10 w-screen mx-auto">
