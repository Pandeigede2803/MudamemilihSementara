...
<div className="flex flex-col items-center justify-center px-6 lg:w-[780px] py-3 mx-auto bg-white shadow-xl">
  <h1 className='text-3xl font-bold mb-10 mt-10'>Prestasi</h1>
  <div className="space-y-6 border-l-2 border-dashed">
    <div className="relative w-full">
      ...
      <div className="ml-6">
        <h4 className="font-bold text-black">Frontend Development.</h4>
        ...
        <span className="mt-1 block text-sm font-semibold text-black">2007</span>
      </div>
    </div>
    <div className="relative w-full">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="absolute -top-0.5 z-10 -ml-3.5 h-7 w-7 rounded-full text-black">
      ...
      <div className="ml-6">
        <h4 className="font-bold text-black">Graphic Design.</h4>
    ...
    <div className="relative w-full">
      ...
      <div className="ml-6">
        <h4 className="font-bold text-black">Lead Ui/Ux Designer.</h4>
        <p className="mt-2 max-w-screen-sm text-sm text-gray-500">Aliquam tincidunt malesuada tortor vitae iaculis. In eu turpis iaculis, feugiat risus quis, aliquet urna. Quisque fringilla mollis risus, eu pulvinar dolor</p>
        <span className="mt-1 block text-sm font-semibold text-black">2007</span>
      </div>
    </div>
